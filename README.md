...
* Evidence streaming using [Elastic Common Schema 9.1](https://www.elastic.co/docs/reference/ecs)
* Evidence streaming using [Splunk HTTP Event Collector 1.0](https://docs.splunk.com/Documentation/Splunk/latest/RESTREF/RESTinput)
